    ...
    { // localhost communication to the RTC program
        ...
        */
        ...
        private static void Plugin_Set(string OriginalFile, string CorruptedFile, string ExternalCorruptor)
        {
            ...
            ChainChomp.ChainChompApplication.mainForm.setRom(OriginalFile);
            ...
            ChainChomp.ChainChompApplication.mainForm.setTarget(CorruptedFile);
            //(corruptorForm as Vinesauce_ROM_Corruptor.MainForm).textBox_EmulatorToRun.Text = ExternalCorruptor;
            ChainChomp.ChainChompApplication.mainForm.setEmu(ExternalCorruptor);
        }
        ...
        private static void Plugin_Corrupt()
        {
            ...
            ChainChomp.ChainChompApplication.mainForm.runButton_Click(new object(), new EventArgs());
        }
