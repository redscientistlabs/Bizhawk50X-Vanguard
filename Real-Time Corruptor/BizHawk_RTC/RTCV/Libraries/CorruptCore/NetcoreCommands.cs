...
namespace CorruptCore
{
	public static class NetcoreCommands
	{
		...
		public const string REMOTE_EVENT_CLOSEBIZHAWK = "REMOTE_EVENT_CLOSEBIZHAWK";
		...
		public const string REMOTE_DOMAIN_SYSTEMPREFIX = "REMOTE_DOMAIN_SYSTEMPREFIX";
		public const string REMOTE_KEY_GETSYSTEMNAME = "REMOTE_KEY_GETSYSTEMNAME";
