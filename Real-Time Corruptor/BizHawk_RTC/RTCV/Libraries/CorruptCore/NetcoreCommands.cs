...
namespace CorruptCore
{
	public static class NetcoreCommands
	{
		...
		public const string ASYNCBLAST = "REMOTE_EVENT_DOMAINSUPDATED";
		...
		public const string REMOTE_SAVESTATE = "GENERATEBLASTLAYER";
		...
		public const string REMOTE_DOMAIN_POKEBYTE = "REMOTE_BACKUPKEY_STASH";
		...
		public const string REMOTE_SET_RESTOREBLASTLAYERBACKUP = "REMOTE_SET_RESTOREBLASTLAYERBACKUP";
		...
		public const string REMOTE_DOMAIN_SYSTEM = "REMOTE_DOMAIN_SYSTEM";
		public const string REMOTE_DOMAIN_SYSTEMPREFIX = "REMOTE_DOMAIN_SYSTEM";
		public const string REMOTE_KEY_GETSYSTEMNAME = "REMOTE_DOMAIN_SYSTEM";
		public const string REMOTE_KEY_GETSYSTEMCORE = "REMOTE_KEY_GETSYSTEMCORE";
		public const string REMOTE_KEY_GETGAMENAME = "REMOTE_KEY_GETGAMENAME";
		public const string REMOTE_KEY_GETSETSYNCSETTINGS = "REMOTE_KEY_GETSETSYNCSETTINGS";
		public const string REMOTE_KEY_GETOPENROMFILENAME = "REMOTE_KEY_GETOPENROMFILENAME";
