...
namespace RTC
{
	...
	public class DataGridViewNumericUpDownColumn : DataGridViewColumn
	{
		...
		[
			Category("Data"),
			Description("Indicates the if the numeric up-down should be in hexadecimal"),
			RefreshProperties(RefreshProperties.All)
		]
		...
		/// Indicates whether the Hexadecimal property should be persisted.
		private bool ShouldSerializeHexadecimal()
		{
			return !this.Maximum.Equals(DataGridViewNumericUpDownCell.DATAGRIDVIEWNUMERICUPDOWNCELL_defaultHexadecimal);
		}
		/// <summary>
	...
	public class DataGridViewNumericUpDownCell : DataGridViewTextBoxCell
	{
		...
		public DataGridViewNumericUpDownCell()
		{
			...
			if (paintingNumericUpDown == null)
			{
				...
				paintingNumericUpDown.Hexadecimal = hexadecimal;
			}
		...
		/// <summary>
		/// The Hexadecimal property replicates the one from the NumericUpDown control
		/// </summary>
		[
		...
		/// Utility function that sets a new value for the Hexadecimal property of the cell. 
